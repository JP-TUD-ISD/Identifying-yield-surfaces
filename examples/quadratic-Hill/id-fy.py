...
hydrorange = [-200, 200]  # interval of hydrostatic points
hydrosteps = 20  # how many points on the hydrostatic axis are tested
thetasteps = 400  # how many directions in the deviatoric plane are tested
...
numericalzero = 0.001  # control if the found minimum is accepted as zero, optimization is aborted if that criterion is met
arange = [0, 8000]  # the range in which the minima searched
...
usepythonFE = True
materialarray = [0.0,] * 500
materialarray[0] = 6969.0  # matswitch
materialarray[6] = 5.5e5  # young's modulus
materialarray[7] = 0.4  # nu
materialarray[8] = 6.0  # idfy, Hill
materialarray[9] = 35.0  # SIY11
materialarray[10] = 50.0  # SIY12
materialarray[11] = 50.0  # SIY13
materialarray[12] = 50.0  # SIY21
materialarray[13] = 50.0  # SIY22
materialarray[14] = 50.0  # SIY23
materialarray[15] = 50.0  # SIY31
materialarray[16] = 50.0  # SIY32
materialarray[17] = 70.0  # SIY33
# values in between are set with F,G,H,L,M,N,O,P,Q in Fortran code
materialarray[27] = 0.0  # hardening modulus
materialarray[28] = 1.0  # 1-dir_1
materialarray[29] = 0.0  # 1-dir_2
materialarray[30] = 0.0  # 1-dir_3
materialarray[31] = 0.0  # 2-dir_1
materialarray[32] = 1.0  # 2-dir_2
materialarray[33] = 0.0  # 2-dir_3
materialarray[37] = 0.0  # rotation around x_1 in degree
materialarray[38] = 0.0  # rotation around x_2 in degree
materialarray[39] = 0.0  # rotation around x_3 in degree
materialarray[40] = 1.0  # idkap
materialarray[41] = 0.0  # debug output
